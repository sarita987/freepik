...
export default ({ data }) => {
  ...
  return (
    <aside className={`${toggle ? "toggle-sidebar" : ""}`}>
      <div className="toggle-btn" onClick={() => handleToggleSidebar(!toggle)}>
      ...
      <div className="sidebar-content">
        ...
        {Object.keys(nodes).map((id) => {
          ...
          if (elemen.textArea === "true" && Object.keys(elemen).length === 4) {
            classname = "image";
            designname = "text";
            nodeType = "default";
          }
          ...
          if (elemen.textField === "true" && Object.keys(elemen).length === 4) {
            classname = "dndnode output";
            designname = "text";
            nodeType = "default";
          }
          ...
          return (
            ...
            >
              ...
              {elemen.textArea === "true" ? (
                <textarea cols="20" rows="3" placeholder="Text Area"></textarea>
              ) : (
                ""
              )}
              {elemen.textArea2 === "true" ? (
